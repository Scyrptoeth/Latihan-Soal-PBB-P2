...
const FEEDBACK_LIST_KEY = "latihan-soal-pbb-p2:feedback:anonymous";
...
function normalizeStoredFeedback(value: unknown): AnonymousFeedback | null {
  ...
  if (typeof rawFeedback.id !== "string" || typeof rawFeedback.message !== "string" || typeof rawFeedback.createdAt !== "string") {
    return null;
  }
